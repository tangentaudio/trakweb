          ...
          <Grid container direction="column" spacing="1px">
            ...
            <Grid item>
              <Grid container direction="row" spacing="1px">
                ...
                <Grid item><Button variant="contained" onClick={() => { props.sendKey(Keys.KBD_kpmultiply) }}>*</Button></Grid>
              </Grid>
            </Grid>
            <Grid item>
            ...
            <Grid item>
              <Grid container direction="row" spacing="1px">
                <Grid item><Button variant="contained" color="secondary" onClick={() => { props.sendKey(Keys.KBD_y) }}>Y</Button></Grid>
            ...
            <Grid item>
              <Grid container direction="row" spacing="1px">
                <Grid item><Button variant="contained" color="secondary" onClick={() => { props.sendKey(Keys.KBD_z) }}>Z</Button></Grid>
