      ...
      <Grid container direction="column" spacing="1px">
        ...
        <Grid item>
          <Grid container direction="row" spacing="1px">
            ...
            <Grid item><KeypadButton sendKeyEvent={props.sendKeyEvent} keyCode={Keys.KBD_kpmultiply} label="*" tooltip="Not used on mill." tipsEnabled={tipsEnabled} /></Grid>
          </Grid>
        </Grid>
        <Grid item>
        ...
        <Grid item>
          <Grid container direction="row" spacing="1px">
            <Grid item><KeypadButton sendKeyEvent={props.sendKeyEvent} keyCode={Keys.KBD_y} label="Y" altColor tooltip="Selects Y axis for subsequent commands" tipsEnabled={tipsEnabled} /></Grid>
        ...
        <Grid item>
          <Grid container direction="row" spacing="1px">
            <Grid item><KeypadButton sendKeyEvent={props.sendKeyEvent} keyCode={Keys.KBD_z} label="Z" altColor tooltip="Selects Z axis for subsequent commands" tipsEnabled={tipsEnabled} /></Grid>
